...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toastr('error', `Registration failed: ${error.response?.data?.message || error.message}`);
    }
  };
...
<div className="col-md-6">
<div className="form-floating mb-3 mb-md-0">
<input className="form-control" id="inputPasswordConfirm" type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} placeholder="Confirm password" />
